                    ...
                    <div class="span12">
                        <div class="widget">
                            <div class="widget-header">
                                ...
                                <a href="<?= set_url('artikel#tambah') ?>" class="btn btn-large btn-primary">Tambah Artikel</a>
                            </div>
                            <div class="widget-content">
                                ...
                                <div class="controls pull-left">
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" id="btn-action-artikel">
                                            <li><a href="<?= site_url('artikel#mass?action=hapus') ?>"><i class="icon-trash"></i> Hapus</a></li>
                                            <li><a href="<?= site_url('artikel#mass?action=pending') ?>"><i class="icon-ban-circle"></i> Pending</a></li>
                                            <li><a href="<?= site_url('artikel#mass?action=publish') ?>"><i class="icon-ok"></i> Publish</a></li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <table id="tbl-artikel" class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td width="16%"><i class="td-actions"></i><a href="<?= set_url('artikel#edit?id=1')?>" class="link-edit btn btn-small btn-info"><i class="btn-icon-only icon-pencil"></i> Edit</a>
                                        <i class="td-actions"></i><a href="<?= set_url('artikel#hapus?id=1')?>" class="btn btn-invert btn btn-small btn-info"><i class="btn-icon-only icon-remove" id="hapus_1"></i> Hapus</a></td>
                                    </tr>
                                    </tbody>
                                </table>
        ...
        <div class="modal-body">
            <form role="form" id="form-artikel" action="tambah">
                <div class="form-group">
                    ...
                    <textarea class="form-control input-block-level" name="post_content" rows="20" id="post_content"></textarea>
                </div>
