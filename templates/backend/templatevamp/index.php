...
<link href="<?= get_template_directory(dirname(__FILE__),'css/'); ?>bootstrap.min.css" rel="stylesheet">
<link href="<?= get_template_directory(dirname(__FILE__),'css/'); ?>bootstrap-responsive.min.css" rel="stylesheet">
<link href="http://fonts.googleapis.com/css?family=Open+Sans:400italic,600italic,400,600"
        rel="stylesheet">
<link href="<?= get_template_directory(dirname(__FILE__),'css/'); ?>font-awesome.css" rel="stylesheet">
<link href="<?= get_template_directory(dirname(__FILE__),'css/'); ?>style.css" rel="stylesheet">
<link href="<?= get_template_directory(dirname(__FILE__),'css/'); ?>pages/dashboard.css" rel="stylesheet">
          ...
          <div class="widget">
            ...
            <div class="widget-content">
              <ul class="messages_layout">
                <li class="from_user left"> <a href="#" class="avatar"><img src="<?= get_template_directory(dirname(__FILE__),'img/'); ?>message_avatar1.png"/></a>
                ...
                <li class="by_myself right"> <a href="#" class="avatar"><img src="<?= get_template_directory(dirname(__FILE__),'img/'); ?>message_avatar2.png"/></a>
                  <div class="message_wrap"> <span class="arrow"></span>
                ...
                <li class="from_user left"> <a href="#" class="avatar"><img src="<?= get_template_directory(dirname(__FILE__),'img/'); ?>message_avatar2.png"/></a>
                  <div class="message_wrap"> <span class="arrow"></span>
