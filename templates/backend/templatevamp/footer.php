...
<script src="<?= get_template_directory(dirname(__FILE__), 'js/') ;?>jquery-ui.min.js"></script>
<script src="<?= get_template_directory(dirname(__FILE__), 'js/') ;?>moment-with-locales.min.js"></script>
<script src="<?= get_template_directory(dirname(__FILE__), 'js/') ;?>underscore-min.js"></script>
